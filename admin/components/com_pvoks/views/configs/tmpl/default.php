...
<div class="pvoksForm">
<form action="<?php echo JRoute::_('index.php?option=com_pvoks&view=configs'); ?>" method="get" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList" class="adminList" style="width:100%">
		<thead>
			<tr>
				...
				<th>
					<?php $pvoksHelper->echoColHeader('PVOKS_CONFIG_TITLE','a.title', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap left">
					<?php $pvoksHelper->echoColHeader('PVOKS_CONFIG_TYPE','a.config_type', $listDirn, $listOrder); ?>
				</th>
			</tr>
		</thead>
		...
		?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="left"><?php echo $this->escape($item->config_type); ?></td>
			</tr>
		<?php endforeach ?>
		</tbody>
		<tfoot>
