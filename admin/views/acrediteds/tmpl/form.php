...
<form method="post" action="<?php echo JRoute::_('index.php?option=com_pvoks&view=configs&id='.(int) $this->item->id);  ?>" id="adminForm" name="adminForm">
	 	<div class="col <?php if(version_compare(JVERSION,'3.0','lt')):  ?>width-60  <?php endif; ?>span8 form-horizontal fltlft">
		  <fieldset class="adminform">
				...
				<div class="control-group">
					<div class="control-label">					
						<?php echo $this->form->getLabel('acredited_id'); ?>
					</div>
					
					<div class="controls">	
						<?php echo $this->form->getInput('acredited_id');  ?>
					</div>
				</div>		
				...
				<div class="control-group">
					<div class="control-label">					
						<?php echo $this->form->getLabel('terminate'); ?>
					</div>
					
					<div class="controls">	
						<?php echo $this->form->getInput('terminate');  ?>
					</div>
				</div>		
		...
		<input type="hidden" name="filter_category_id" value="<?php echo $input->get('filter_category_id'); ?>" />
		<input type="hidden" name="filter_user_id" value="<?php echo $input->get('filter_user_id'); ?>" />
		<input type="hidden" name="filter_acredited_id" value="<?php echo $input->get('filter_acredited_id'); ?>" />
